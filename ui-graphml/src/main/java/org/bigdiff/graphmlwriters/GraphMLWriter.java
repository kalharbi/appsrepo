...
public class GraphMLWriter {
     ...
     *
     * @param nodeId  node id of the node in the beginning of the vertex
     *                representation.
     * @param dataMap a map of key/value pairs associated with the given graph
     *                nodeId element.
     */
     ...
     * @param label    a label denoting the relationship represented by the edge.
     * @param dataMap  a map of edge properties defined by a map from key to value.
     */
